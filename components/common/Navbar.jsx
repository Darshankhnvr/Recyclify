    ...
    <nav className="bg-green-600 text-white p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="space-x-4 flex items-center">
          <Link href="/guides" className="hover:text-green-200">
            Guides
          </Link>{" "}
          <Link href="/centers" className="hover:text-green-200">
            Centers
          </Link>
          <Link href="/leaderboard" className="hover:text-green-200">
            Leaderboard
          </Link>
          <SignedOut>
          ...
          <SignedIn>
            <Link href="/overview" className="hover:text-green-200">
              Dashboard
            </Link>
